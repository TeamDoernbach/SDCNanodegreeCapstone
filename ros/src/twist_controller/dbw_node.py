        ...
        while not rospy.is_shutdown():
            if(self.dbw_enabled) and \
              ...
              (self.current_vel is not None):
                calc_params = {
                    'linear_vel': self.current_setpoint.twist.linear.x,
                    'angular_vel': self.current_setpoint.twist.angular.z,
                    'current_vel': self.current_vel.twist.linear.x
                }
